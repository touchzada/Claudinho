...
const DEFAULT_PREFIX = `You are Claudinho, an AI coding CLI assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Claudinho, an AI coding CLI assistant running within the agent SDK.`
const AGENT_SDK_PREFIX = `You are a Claudinho agent built on the agent SDK.`
