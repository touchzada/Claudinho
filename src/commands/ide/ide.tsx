...
function IDEScreen(t0) {
  ...
  if ($[26] !== availableIDEs.length) {
    t8 = availableIDEs.length !== 0 && !isSupportedTerminal() && <Box marginTop={1}><Text dimColor={true}>Dica: Você pode ativar auto-conexão com a IDE em /config ou com a flag --ide</Text></Box>;
