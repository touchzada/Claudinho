...
const GOODBYE_MESSAGES = [
  ...
  'Até mais véi!',
  'De boas?',
  'Tchau tchau, não esquece de mim não!',
  'Valeu parça!',
  'Qualé!',
  'Se cuida na fé!',
  'Partiu!',
  'É o pix, é o pix!',
  'Vazou!',
  'Tamo on até mais tarde!',
  'Flw, abraço!',
  'Suave na nave?',
  'Bota fé!',
  'Tamo na ativa!',
  'Até a próxima, se a matrix deixar!',

  // --- Memes de Dev ---
  'git commit -m "saindo"',
  'Ctrl+D na vida',
  'Fechando as tabs...',
  'Saindo antes do deploy quebrar',
  'Processo finalizado com código 0',
  'node: saindo do event loop',
  'npm run goodbye',
  'Build succeeded: adeus!',
  'Saindo... mas volto depois do lunch break',
  'Encerrando sessão. Motivo: vida real',
  'throw new GoodbyeException()',
  'Saindo antes que o estagiário toque em prod',
  'Desligando. Não é você, sou eu (e o código)',

  // --- Originais abrasileirados ---
  'Tchauzin!',
  'Até logo 👋',
  'Foi mal, fui!',
  'Até a próxima!',
