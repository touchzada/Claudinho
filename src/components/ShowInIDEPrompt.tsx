...
export function ShowInIDEPrompt(t0) {
  ...
  let t5;
  if ($[7] !== t4) {
    t5 = <Text>Você quer fazer essa edição em{" "}<Text bold={true}>{t4}</Text>?</Text>;
    $[7] = t4;
    $[8] = t5;
  } else {
    t5 = $[8];
  ...
  const t11 = (focusedOption === "yes" && !yesInputMode || focusedOption === "no" && !noInputMode) && " · Tab pra complementar sua resposta";
  let t12;
  if ($[29] !== t11) {
