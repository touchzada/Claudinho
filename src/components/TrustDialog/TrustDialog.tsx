...
export function TrustDialog(t0) {
  ...
  if ($[24] === Symbol.for("react.memo_cache_sentinel")) {
    t20 = [{
      label: "Sim, eu confio nesta pasta",
      value: "enable_all"
    }, {
      label: "Não, sair",
      value: "exit"
  ...
  if ($[27] !== exitState.keyName || $[28] !== exitState.pending) {
    t22 = <Text dimColor={true}>{exitState.pending ? <>Pressione {exitState.keyName} novamente pra sair</> : <>Enter pra confirmar · Esc pra cancelar</>}</Text>;
