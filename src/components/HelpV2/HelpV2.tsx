...
export function HelpV2(t0) {
  ...
  if ($[9] !== antOnlyCommands || $[10] !== builtinCommands || $[11] !== close || $[12] !== columns || $[13] !== customCommands || $[14] !== maxHeight) {
    ...
    if ($[16] !== builtinCommands || $[17] !== close || $[18] !== columns || $[19] !== maxHeight) {
      t5 = <Tab key="commands" title="comandos"><Commands commands={builtinCommands} maxHeight={maxHeight} columns={columns} title="Navegar comandos padrão:" onCancel={close} /></Tab>;
      $[16] = builtinCommands;
      $[17] = close;
      $[18] = columns;
      $[19] = maxHeight;
    ...
    if ($[21] !== close || $[22] !== columns || $[23] !== customCommands || $[24] !== maxHeight) {
      t6 = <Tab key="custom" title="comandos-customizados"><Commands commands={customCommands} maxHeight={maxHeight} columns={columns} title="Navegar comandos customizados:" emptyMessage="Nenhum comando customizado encontrado" onCancel={close} /></Tab>;
      $[21] = close;
      $[22] = columns;
      $[23] = customCommands;
      $[24] = maxHeight;
  ...
  let t6;
  if ($[31] !== tabs) {
    t6 = <Tabs title={false ? "/help" : `Claudinho v${MACRO.VERSION}`} color="professionalBlue" defaultTab="general">{tabs}</Tabs>;
    $[31] = tabs;
    $[32] = t6;
  } else {
    t6 = $[32];
  ...
  if ($[33] === Symbol.for("react.memo_cache_sentinel")) {
    t7 = <Box marginTop={1}><Text>Caso ainda tenha dúvida... Bom, pergunta pro Claudinho hehe</Text></Box>;
    $[33] = t7;
  } else {
    t7 = $[33];
  }
  ...
  if ($[34] !== dismissShortcut || $[35] !== exitState.keyName || $[36] !== exitState.pending) {
    t8 = <Box marginTop={1}><Text dimColor={true}>{exitState.pending ? <>Press {exitState.keyName} again to exit</> : <Text italic={true}>{dismissShortcut} pra cancelar</Text>}</Text></Box>;
    $[34] = dismissShortcut;
